...
def run_node_checks() -> None:
    ...
    subprocess.run(
        [
            "node", "--test",
            "tests/js/plugin_manager.test.js",
            "tests/js/process_result.test.js",
            "tests/js/command_security.test.js",
            "tests/js/provider_script_routing.test.js",
            "tests/js/plugin_release_policy.test.js",
            "tests/js/plugin_state_migration.test.js",
            "tests/js/provider_legacy_compat.test.js",
            "tests/js/time_format.test.js",
            "tests/js/form_drafts.test.js",
            "tests/js/recent_inputs.test.js",
            "tests/js/manifest_form_validation.test.js",
            "tests/js/import_write_guidance.test.js",
            "tests/js/task_accessibility.test.js",
            "tests/js/task_report.test.js",
            "tests/js/task_history.test.js",
            "tests/js/task_history_persistence.test.js",
            "tests/js/task_resume.test.js",
            "tests/js/provider_toc_contract.test.js",
            "tests/js/toc_tree.test.js",
            "tests/js/toc_rendering.test.js",
        ],
        cwd=REPO_ROOT,
        check=True,
    )
